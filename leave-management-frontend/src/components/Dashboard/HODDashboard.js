...
const HODDashboard = () => {
  ...
  const tabs = [
    ...
    { id: 'approvals', label: 'Pending Approvals', icon: '✅', badge: dashboardStats?.pending_to_review || 0 },
        ...
        <div className="card mb-4">
          <div style={{ padding: '1.5rem' }}>
            ...
            <p style={{ 
              ...
              Head of Department Dashboard - Employee #{user?.employee_number}
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              {dashboardStats?.pending_to_review > 0 && (
                <div className="alert alert-warning mb-4">
                  <h4 style={{ marginBottom: '0.5rem' }}>Action Required</h4>
                  <p style={{ margin: 0 }}>
                    You have {dashboardStats.pending_to_review} staff leave application{dashboardStats.pending_to_review !== 1 ? 's' : ''} waiting for your approval.
                    <button
          ...
          <div style={{ padding: '1rem' }}>
            <div className="btn-group">
              {dashboardStats?.pending_to_review > 0 && (
                ...
                >
                  Review Pending ({dashboardStats.pending_to_review})
                </button>
              )}
              <button
